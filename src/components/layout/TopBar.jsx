...
>>>>>>> a8b67df4aba83266168d9625ada638299e42d0cd
      ...
      <div className="flex-1 max-w-md px-4">
        <div className="relative">
          ...
          <input
            type="text"
            className="block w-full pl-10 pr-3 py-2 border border-[var(--border-subtle)] rounded-full leading-5 bg-[var(--surface-1)] text-zinc-300 placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-[var(--brand)] sm:text-sm"
      ...
      <div className="flex items-center gap-6 flex-1 justify-end">
        <button
          className="relative p-2 text-zinc-400 hover:text-[var(--text-primary)] transition-colors rounded-full"
        ...
        <div className="flex items-center gap-2 bg-[var(--surface-1)] py-1.5 px-3 rounded-full border border-[var(--border-subtle)]">
